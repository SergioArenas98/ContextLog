...
mixin _$ProjectModel {
 ...
 String get id; String get name; String? get rubiconCode; String? get licenceNumber; DateTime get createdAt; DateTime get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,rubiconCode,licenceNumber,createdAt,updatedAt);

@override
String toString() {
  return 'ProjectModel(id: $id, name: $name, rubiconCode: $rubiconCode, licenceNumber: $licenceNumber, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, String? rubiconCode, String? licenceNumber, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of ProjectModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? rubiconCode = freezed,Object? licenceNumber = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
as String?,licenceNumber: freezed == licenceNumber ? _self.licenceNumber : licenceNumber // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? rubiconCode,  String? licenceNumber,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.id,_that.name,_that.rubiconCode,_that.licenceNumber,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? rubiconCode,  String? licenceNumber,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ProjectModel():
return $default(_that.id,_that.name,_that.rubiconCode,_that.licenceNumber,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? rubiconCode,  String? licenceNumber,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.id,_that.name,_that.rubiconCode,_that.licenceNumber,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _ProjectModel implements ProjectModel {
  const _ProjectModel({required this.id, required this.name, this.rubiconCode, this.licenceNumber, required this.createdAt, required this.updatedAt});
...
/// Create a copy of ProjectModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? rubiconCode = freezed,Object? licenceNumber = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
